                        ...
                        {users.map((user: User, index) => (
                            <div className={styles.jobContainer} key={index}>
                                ...
                                <div className={styles.jobContainer__body}>
                                    ...
                                    <span style={{ color: '#717273', fontSize: '19px', fontWeight: 'normal', wordBreak: 'break-word', overflow: 'hidden' }} className={globalStyles.simpleP}> {user.about ? user.about : 'No about'}</span>
